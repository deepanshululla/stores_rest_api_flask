    ...
    def test_item_found(self):
        with self.app() as c:
            with self.app_context():
                ...
                self.assertDictEqual(d1={'name': 'test', 'price': 17.99, 'store_id':1},
    ...
    def test_create_duplicate_item(self):
        with self.app() as c:
            with self.app_context():
                ...
                self.assertDictEqual({'message': "The item with name {} already exists".format('test')},
                                     json.loads(r.data))
    ...
    def test_item_list(self):
        with self.app() as c:
            with self.app_context():
                ...
                self.assertDictEqual(d1={'items': [{'name': 'test', 'price': 17.99, 'store_id': 1}]},
                                     d2=json.loads(r.data))
